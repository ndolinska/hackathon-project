    ...
    <nav className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
      ...
      <div className="card-cream pixel-border p-6 relative overflow-hidden">
        ...
        <p className="retro-font text-lg md:text-xl text-amber-800 mb-4">
          Naucz się opiekować wirtualnym kotkiem w stylu Tamagotchi! Karm, baw się i dbaj o swojego pupila.
        </p>
        <button onClick={() => onSelectSection('tutorial')} className="pixel-btn bg-amber-600 text-white px-4 py-3 pixel-font text-xs w-full hover:bg-amber-700">
          ▶ ROZPOCZNIJ TUTORIAL
        </button>
      </div>
      ...
      <div className="card-orange pixel-border p-6 relative overflow-hidden">
        ...
        <h2 className="pixel-font text-sm md:text-base text-amber-900 mb-4 flex items-center">
          <span className="w-8">🐾</span> GALERIA
        </h2>
        <p className="retro-font text-lg md:text-xl text-amber-800 mb-4">
      ...
      <div className="card-orange pixel-border p-6 relative overflow-hidden">
        ...
        <h2 className="pixel-font text-sm md:text-base text-amber-900 mb-4 flex items-center">
          <span className="w-8">📋</span> ADOPCJA
        </h2>
        <p className="retro-font text-lg md:text-xl text-amber-800 mb-4">
          Wybierz rodzaj adopcji: tymczasowa, stała lub wirtualne wsparcie dla prawdziwych kotów.
        </p>
        <button onClick={() => onSelectSection('adoption')} className="pixel-btn bg-orange-700 text-white px-4 py-3 pixel-font text-xs w-full hover:bg-orange-800">
          📝 RODZAJE ADOPCJI
        </button>
      </div>
      ...
      <div className="card-cream pixel-border p-6 relative overflow-hidden">
        ...
        <h2 className="pixel-font text-sm md:text-base text-amber-900 mb-4 flex items-center">
          <span className="w-8">💝</span> WESPRZYJ
        </h2>
        <p className="retro-font text-lg md:text-xl text-amber-800 mb-4">
          Twoja wpłata pomaga prawdziwym kotom w schroniskach. Każda złotówka się liczy!
        </p>
        <button onClick={() => onSelectSection('donate')} className="pixel-btn bg-rose-600 text-white px-4 py-3 pixel-font text-xs w-full hover:bg-rose-700">
          💖 WPŁAĆ DATEK
        </button>
      </div>
